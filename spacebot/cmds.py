    ...
    def register(self, *args, **kwargs):
        return self.add_command(
            *args,
            ...
            ignore_argument_errors=self.ignore_argument_errors,
            **kwargs,
        )
...
class Commander(BaseComponent):
    ...
    def add_command(
        self, cmd, callback, no_args=False, exceptions=(), nargs='+', default=None, public=False, private=False, admin=False, threaded=False, ignore_argument_errors=False, **kwargs
    ):
